...
KEYBOARDENTRY scancodesets[3][104] = { //All scan codes for all sets!
	...
	{{0xE1,0x1D,0x45,0xE1,0x9D,0xC5,0x00,0x00},6,{0xE1,0x9D,0xC5,0x00,0x00,0x00,0x00,0x00},0}, //PAUSE
	...
	{{0xE0,0x47,0x00,0x00,0x00,0x00,0x00,0x00},2,{0xE0,0xC7,0x00,0x00,0x00,0x00,0x00,0x00},2}, //HOME
	...
	{{0xE1,0x14,0x77,0xE1,0xF0,0x14,0xF0,0x77},8,{0xF0,0x14,0xF0,0x77,0x00,0x00,0x00,0x00},0}, //PAUSE
...
KEYBOARDENTRY_EXTENDED CTRLSHIFTSYSRQ[3] = {
	{{{0xE0,0x37,0x00,0x00,0x00,0x00},2,{0xE0,0xB7,0x00,0x00,0x00,0x00},2},1},
	{{{0xE0,0x7C,0x00,0x00,0x00,0x00},2,{0xE0,0xF0,0x7C,0x00,0x00,0x00},2},1},
	{{{0xE0,0x37,0xD4,0x00,0x00,0x00},3,{0x00,0x00,0x00,0x00,0x00,0x00},0},0}
};

KEYBOARDENTRY_EXTENDED ALTSYSRQ[3] = {
	{{{0x54,0x00,0x00,0x00,0x00,0x00},1,{0xD4,0x00,0x00,0x00,0x00,0x00},1},1},
	{{{0x84,0x00,0x00,0x00,0x00,0x00},1,{0xF0,0x84,0x00,0x00,0x00,0x00},2},1},
	{{{0x57,0x00,0x00,0x00,0x00,0x00},1,{0xF0,0x57,0x00,0x00,0x00,0x00},2},1}
};

KEYBOARDENTRY_EXTENDED CTRLBREAK[3] = {
	{{{0xE0,0x46,0xE0,0xC6,0x00,0x00},4,{0xE0,0xC6,0x00,0x00,0x00,0x00},0},1},
	{{{0xE0,0x7E,0xE0,0xF0,0x7E,0x00},6,{0xE0,0xF0,0x7E,0x00,0x00,0x00},0},1},
	{{{0x62,0x00,0x00,0x00,0x00,0x00},1,{0xF0,0x62,0x00,0x00,0x00,0x00},2},1}
};

KEYBOARDENTRY_EXTENDED NUMLOCK_SLASH_PRESUFFIX[3][4][3] = //Prefix before make code, suffix after break code. Index[NumLockOn(0&1 for numlocked keys, 2 for numlock slash)][shiftstatus][scancodeset]
{
{ //NUMLOCK off!
	{ //No shift!
		{ { { 0xE0,0x46,0x00,0x00,0x00,0x00 },0,{ 0xE0,0xC6,0x00,0x00,0x00,0x00 },0 },0 },
		{ { { 0xE0,0x7E,0x00,0x00,0x00,0x00 },0,{ 0xE0,0xF0,0x7E,0x00,0x00,0x00 },0 },0 },
		{ { { 0x62,0x00,0x00,0x00,0x00,0x00 },0,{ 0xF0,0x62,0x00,0x00,0x00,0x00 },0 },0 }
	},
	{ //L shift! Release the fake left shift when pressed, press the fake left shift when released!
		{ { { 0xE0,0xAA,0x00,0x00,0x00,0x00 },2,{ 0xE0,0x2A,0x00,0x00,0x00,0x00 },2 },1 },
		{ { { 0xE0,0xF0,0x12,0x00,0x00,0x00 },3,{ 0xE0,0x12,0x00,0x00,0x00,0x00 },2 },1 },
		{ { { 0xE0,0xF0,0x12,0x00,0x00,0x00 },3,{ 0xE0,0x12,0x00,0x00,0x00,0x00 },2 },1 },
	},
	{ //R shift!
		{ { { 0xE0,0xB6,0x00,0x00,0x00,0x00 },2,{ 0xE0,0x36,0x00,0x00,0x00,0x00 },2 },1 },
		{ { { 0xE0,0xF0,0x59,0x00,0x00,0x00 },3,{ 0xE0,0x59,0x00,0x00,0x00,0x00 },2 },1 },
		{ { { 0xE0,0xF0,0x59,0x00,0x00,0x00 },3,{ 0xE0,0x59,0x00,0x00,0x00,0x00 },2 },1 },
	},
	{ //LR shift!
		{ { { 0xE0,0xAA,0xE0,0xB6,0x00,0x00 },4,{ 0xE0,0x36,0xE0,0x2A,0x00,0x00 },4 },1 },
		{ { { 0xE0,0xF0,0x12,0xE0,0xF0,0x59 },6,{ 0xE0,0x59,0xE0,0x12,0x00,0x00 },4 },1 },
		{ { { 0xE0,0xF0,0x12,0xE0,0xF0,0x59 },6,{ 0xE0,0x59,0xE0,0x12,0x00,0x00 },4 },1 },
	}
}, //NUMLOCK off!
{ //NUMLOCK on!
	{//No shift! Press the left shift only?
		{ { { 0xE0,0x2A,0x00,0x00,0x00,0x00 },2,{ 0xE0,0xAA,0x00,0x00,0x00,0x00 },2 },1 },
		{ { { 0xE0,0x12,0x00,0x00,0x00,0x00 },2,{ 0xE0,0xF0,0x12,0x00,0x00,0x00 },3 },1 },
		{ { { 0xE0,0x12,0x00,0x00,0x00,0x00 },2,{ 0xE0,0xF0,0x12,0x00,0x00,0x00 },3 },1 },
	},
	{ //L shift!
		{ { { 0xE0,0x46,0x00,0x00,0x00,0x00 },0,{ 0xE0,0xC6,0x00,0x00,0x00,0x00 },0 },0 },
...
{ //NumLock Slash!
	{ //No shift!
		{ { { 0xE0,0xAA,0x00,0x00,0x00,0x00 },0,{ 0xE0,0x2A,0x00,0x00,0x00,0x00 },0 },0 },
		{ { { 0xE0,0xF0,0x12,0x00,0x00,0x00 },0,{ 0xE0,0x12,0x7E,0x00,0x00,0x00 },0 },0 },
		{ { { 0x62,0x00,0x00,0x00,0x00,0x00 },0,{ 0xF0,0x62,0x00,0x00,0x00,0x00 },0 },0 }
	},
	{ //L shift!
		{ { { 0xE0,0xAA,0x00,0x00,0x00,0x00 },2,{ 0xE0,0x2A,0x00,0x00,0x00,0x00 },2 },1 },
